...
$SORGU = $DB->prepare("SELECT id, name, surname FROM users WHERE role = 'Student'");
$SORGU->execute();
$students = $SORGU->fetchAll(PDO::FETCH_ASSOC);



$SORGU_2 = $DB->prepare("SELECT id, lesson_name FROM lessons");
$SORGU_2->execute();
...
<div class="container-fluid">
  ...
  <div class="container">
    <div class="row justify-content-center">
      <form method="POST" action="fonk_add_new_exam_score.php">
