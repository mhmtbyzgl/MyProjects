...
$SORGU_2 = $DB->prepare("SELECT A.id, A.name, A.surname
FROM users A
WHERE A.role = 'Student' AND
NOT EXISTS (
    SELECT 1
    FROM classes_students B
...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div class="row">
      <h1 class="h3 mb-0 text-gray-800">Sınıfa Öğrenci Ekleme</h1>
      <p id="autoHideP">
  ...
  <div class="container">
    <div class="row justify-content-center">
      <form method="POST" action="fonk_add_new_student_to_class.php">


        <div class="col-md-12 mb-3 text-center">
          <span>Öğrenci Seçiniz:</span>
          <select class="form-select ml-2 mb-3" aria-label="Default select example" name="selectedStudent">
        ...
        <div class="col-md-12 mb-3 text-center">
          <button type="submit" class="btn btn-success">Ekle</button> <a href="students_info.php" type="button" class="btn btn-warning mr-1">Geri Dön</a>
        </div>
      </form>
    </div>
  </div>
