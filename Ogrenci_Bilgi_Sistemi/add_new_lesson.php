...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div class="row">
      <h1 class="h3 mb-0 text-gray-800">Ders Ekleme</h1>
      <p id="autoHideP">
  ...
  <div class="container">
    <div class="row justify-content-center">
      <form method="POST" action="fonk_add_lesson.php">


        <div class="col-md-12 mb-3">
          <input type="text" class="form-control" name="lessonName" placeholder="Ders Adı">
        </div>
        ...
        <div class="col-md-12 mb-3 text-center">
          <button type="submit" class="btn btn-success">Ekle</button> <a href="lessons_info.php" type="button" class="btn btn-warning mr-1">Geri Dön</a>
        </div>
      </form>
    </div>
  </div>
