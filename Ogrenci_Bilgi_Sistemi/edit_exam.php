...
<div class="container-fluid">
  ...
  <div class="container">
    <div class="row justify-content-center">
      <form method="POST" action="fonk_update_exam_score.php?id=<?= $id ?>">
        ...
        <div class="col-md-12 mb-3 text-center">
          <button type="submit" class="btn btn-success">Güncelle</button> <a href="exams_info.php" type="button" class="btn btn-warning mr-1">Geri Dön</a>
        </div>
      </form>
    </div>
  </div>
